 ...
 */
EC_PUBLIC_API int ecrt_master_send(ec_master_t* master /**< EtherCAT master. */
);
 ...
 */
int ecrt_master_send_ext(ec_master_t* master /**< EtherCAT master. */
);
#endif
 ...
 * \return 0 on success, otherwise negative error code.
 */
EC_PUBLIC_API int ecrt_master_reset(ec_master_t* master /**< EtherCAT master. */
);
 ...
 */
EC_PUBLIC_API size_t ecrt_domain_size(const ec_domain_t* domain /**< Domain. */
);
 ...
 * \apiusage{master_idle,blocking}
 */
void ecrt_domain_external_memory(ec_domain_t* domain, /**< Domain. */
                                 uint8_t* memory /**< Address of the memory to
                                                   store the process data in. */
);
 ...
 * \return 0 on success, otherwise negative error code.
 */
EC_PUBLIC_API int ecrt_domain_process(ec_domain_t* domain /**< Domain. */
);
 ...
 * \return 0 on success, otherwise negative error code.
 */
EC_PUBLIC_API int ecrt_domain_queue(ec_domain_t* domain /**< Domain. */
);
